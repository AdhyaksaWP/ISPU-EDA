...
# %%
sampling_locs = camelot.read_pdf("./data/airsungai_20250702121933.pdf", pages="60-62", flavor='lattice')
...
# %%
tables = camelot.read_pdf("./data/airsungai_20250702121933.pdf", pages="66-113", flavor='lattice')
...
# %%
table2020 = camelot.read_pdf("./data/airsungai_20250702121933.pdf", pages="115", flavor='lattice')
...
# Export
output_file = 'data/cleaned/river_quality_2015-2025_expanded.csv'
